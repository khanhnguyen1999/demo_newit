...
const CreateQuestion = ()=>{
    ...
    for (let i = 0; i < tags.length; i++) {
        children.push(<Select.Option value={tags[i]._id} key={tags[i]._id}>{tags[i].tagName}</Select.Option>);
    ...
    const _onSubmitEssay = (e)=>{
        ...
        data.append("id_tag",data.get("id_tag"))
            ...
            <Form onSubmit={_onSubmitEssay}>
                ...
                >
                    ...
                    <Form.Group id="1" controlId="formBasicPassword">
                        ...
                        <Input id="answerA" name="answerA" type="text" placeholder="Password" />
                    </Form.Group>
                    <Form.Group id="2" controlId="formBasicPassword">
                        <Form.Label>Answer B</Form.Label>
                        <Input id="answerB" name="answerB" type="text" placeholder="Password" />
                    </Form.Group>
                    <Form.Group id="3" controlId="formBasicPassword">
                        <Form.Label>Answer C</Form.Label>
                        <Input id="answerC" name="answerC" type="text" placeholder="Password" />
                    </Form.Group>
                    <Form.Group id="4" controlId="formBasicPassword">
                        <Form.Label>Answer D</Form.Label>
                        <Input id="answerD" name="answerD" type="text" placeholder="Password" />
                    </Form.Group>
                    <p>True Correct</p>
