...
const CreateQuestion = ()=>{
    ...
    for (let i = 0; i < tags.length; i++) {
        children.push(<Select.Option key={i}>{tags[i].tagName}</Select.Option>);
    }
    ...
    const _settingQuestiong = ()=>{
        return (
            ...
            <Form.Label>Level:</Form.Label>
                <Select className="mt-3" defaultValue="1" style={{ width: 150 }} onChange={_handleOnChangeAnswer}>
        ...
        return (
            <Form onSubmit={_onSubmitMul}>
                ...
                <Form.Group controlId="formBasicPassword">
                        ...
                        <TimePicker className="ml-3" onChange={onChange} defaultOpenValue={moment('00:00:00', 'HH:mm:ss')} />
                </Form.Group>
            </Form>
        )
    }
